...
const CONFIG = {
  // Business identity
  name: "SPOT Pest Control",
  tagline: "Uw expert in ongediertebestrijding.",
  logoUrl: "/logo.png",
  logoAlt: "SPOT Pest Control Logo",
  logoClassName: "h-8 md:h-10",

  // Contact
  phone: "+32 468 47 57 62",
  phoneLink: "tel:+32468475762",
  email: "contact@spotpestcontrol.be",
  whatsapp: "https://api.whatsapp.com/send?phone=32468475762",

  // Location
  address: "Montenaken 8, 3202 Aarschot",
  region: "Brussel, Antwerpen en Leuven",
  ...
  // About text
  aboutText: "SPOT Pest Control is een regionale ongediertebestrijder actief in Antwerpen, Leuven en Brussel. Wij bieden deskundige oplossingen voor ongedierte en effectieve preventie voor bedrijven en woningen. Onze visie: respect voor het milieu, preventie vóór bestrijding, kennis van het ongedierte, en snelle service.",
